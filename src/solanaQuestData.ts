export const solanaQuestData = {
  heading: "Intro to Solana",
  subheading: "Fundamentals of the Solana Blockchain",
  track_image: "https://example.com/solana_intro.jpg",
  points: 600,
  subtracks: [
    {
      ...
      quiz: [
        {
          ...
          options: ["a) To store executable program code", "b) To store user profiles", "c) To manage network nodes"],
          answer: "a) To store executable program code",
          explaination:
            "Accounts in Solana are primarily used to store executable program code and program state, allowing for efficient data management on the blockchain.",
        },
        {
          ...
          answer: "b) Three",
          explaination:
            "When deploying a program on Solana, three separate accounts are created: the Program Account, the Program Executable Data Account, and the Buffer Account.",
        },
      ],
    },
      ...
      quiz: [
        {
          ...
          explaination: "The base transaction fee on Solana is set at 5,000 lamports per signature.",
        },
        {
          question: "What percentage of transaction fees is burned?",
          options: ["a) 25%", "b) 50%", "c) 75%"],
          answer: "b) 50%",
          explaination: "50% of each transaction fee is burned to control inflation and stabilize the value of SOL.",
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          answer: "b) 1232 bytes",
          explaination: "The maximum size of a Solana transaction is 1232 bytes, ensuring efficient transmission of data over the network.",
        },
        {
