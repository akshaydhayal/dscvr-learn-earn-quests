...
const Card = ({ imageSrc, title, subtitle, xp,subtrack_index,trackName }:
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden shadow-2xl min-w-56 w-[19%] border-2 border-slate-500 cursor-pointer
    hover:border-slate-400" onClick={()=>{
        ...
        <img src={`/quest${subtrack_index}.png`} alt={title} loading="lazy" className="w-full h-40 object-cover" />
